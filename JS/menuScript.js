	...
	this.process = function(name){
		...
		if(flag == 0){    
          ...
          // creando elementi direttamente qui:
		    ...
		    b1.setAttribute("class","buttonInside button add glyphicon glyphicon-plus");
		    //b1.innerHTML = "+";
		    let b2 = document.createElement("button");
		    b2.setAttribute("class","buttonInside glyphicon glyphicon-minus");
		    //b2.innerHTML = "-";
		    let b3 = document.createElement("button");
		    b3.setAttribute("class","buttonInside button add glyphicon glyphicon-trash");
		    //b3.innerHTML = "x";
		    buttons.appendChild(b1);
		    buttons.appendChild(b2);
            buttons.appendChild(b3);
		    buttons.setAttribute("class","itemsInside");
