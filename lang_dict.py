phase_selected = {
    'Book': 'Starting Booking phase...',
    'Order': 'Starting Ordering phase...'
}

main_menu = {
    "Book": "Please complete all menu's options:",
    "Order": "Por favor selecciona una de las siguientes opciones:",
}

send_report = {
    # "ES": "Enviar reporte",
    # "EN": "Send report"
    'Book': 'How many people are you booking for?',
    'Order': ''
}
